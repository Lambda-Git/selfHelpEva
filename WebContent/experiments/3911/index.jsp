...
<script type="text/javascript">
  ...
  $("#start_test").click(function(){
    para=$("#speed").val();
    window.location.href="instruction_img.jsp?taskid=<%=taskid%>&lan=<%=lan%>&targetpagename=<%=targetpagename%>&codematerial=0&projectid=<%=projectid%>&endValue=0&taskid=3782&speed="+para+"&num1="+num1+"&num2="+num2;
  });
